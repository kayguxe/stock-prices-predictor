...
def stock_prediction():
	    ...
	    if ((prediction[0][0]-dataset[0]) > 0):
	    	result = 'The price will go up from %s to %s' % (dataset[0], prediction[0][0])
	    else:
	    	result = 'The price will drop from %s to %s' % (dataset[0], prediction[0][0])
